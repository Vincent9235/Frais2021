...
namespace Frais2020b
{
  public partial class Form1 : Form
  {
    ...
    {
      InitializeComponent();
      string st = "server=localhost;uid=frais2020;password=frais2020;database=frais";
    ...
    private void mnuConnexion_Click(object sender, EventArgs e)
    {
      ...
      if (Fiche.ShowDialog() == DialogResult.OK)
      {
        ...
        sqlCommande.CommandText = "select nom_adherent,id_adherent " +
          "from adherents " +
          "where login_adherent='" + id + "' and mdp_adherent='" + pw + "'";
    ...
    {
      sqlCommande.CommandText = "select * from notefrais "+
